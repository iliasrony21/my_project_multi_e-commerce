...
class IndexController extends Controller
{
    public function ProductDetails($id,$slug){
     ...
     public function Index(){
        ...
        return view('frontend.index',compact('skip_category_0','skip_product_0','skip_category_2','skip_product_2','skip_category_5','skip_product_5','hot_deals','special_offer','new','special_deals'));
