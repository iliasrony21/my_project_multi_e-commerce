                    ...
                    <div class="form-body mt-4">
                        ...
                        <form id="myForm" method="post" action="{{ route('store.product') }}" enctype="multipart/form-data" >
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="product_size" class="form-control visually-hidden" data-role="tagsinput" value="Small, Midium, Large, Extra Large ">
                            </div>
                            ...
                            <div class="form-group mb-3">
				                ...
				                <img src="" id="mainThmb" class="mt-2" style="margin-left: 25px;" />
                            </div>
                            <div class="form-group mb-3">
                                <label for="inputProductTitle" class="form-label">Multiple Image</label>
                                <input class="form-control" name="multi_img[]" type="file" id="multiImg" multiple="">
                                <div class="row mt-4" style="margin-left: 25px;" id="preview_img"></div>
                            </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="vendor_id" class="form-select" id="inputCollection">
                                        <option>Select Your Vendor</option>
