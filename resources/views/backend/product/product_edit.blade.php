...
<div class="page-content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="vendor_id" class="form-select" id="inputCollection">
                                        ...
                                        <option value="{{ $vendor->id }}" {{ $vendor->id == $products->vendor_id ? 'selected' : '' }}>{{ $vendor->username }}</option>
                                        @endforeach
                                    </select>
                                </div>
        ...
        <form method="post" action="{{ route('update.product.thambnail') }}"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ asset($products->product_thambnail) }}"  id="mainThmb" alt="" style="width: 100px; height: 100px; margin-left: 20px;">
                        </div>
        ...
        </div> <!-- End Main Img Thambnail Update -->
