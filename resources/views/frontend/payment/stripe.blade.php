...
<!-- stripe template frontend table  -->
<form action="{{ route('stripe.order') }}" method="post" id="payment-form">
  ...
  <input type="hidden" name="notes" value="{{ $data['notes'] }}">
    ...
    //publishable key past here
var stripe = Stripe('pk_test_51NL63NEfqosZjrtScEwqLZoj8uDHCupDIwiwOHfbxt0teWjyVtM8vFZXeME5RpG2bPA2SJWSQhJoDf57a3hTc7TC00Bo5h1R0u');
