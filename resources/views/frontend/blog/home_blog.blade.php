...
<article class="wow fadeIn animated hover-up mb-30 animated">
    ...
    <div class="entry-content-2 pl-50">
        ...
        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
            ...
            <a href="{{ url('post/details/'.$post->id.'/'.$post->post_slug) }}" class="text-brand font-heading font-weight-bold">Read more <i class="fi-rs-arrow-right"></i></a>        </div>
    </div>
</article>
            @endforeach
    ...
    $posts = App\Models\BlogPost::where('category_id',$category->id)->get();
            ...
            <li>
            <a href="{{ url('post/category/'.$category->id.'/'.$category->blog_category_slug) }}"> <img src="{{ asset('frontend/assets/imgs/theme/icons/category-1.svg') }}" alt="" />{{ $category->blog_category_name }}</a><span class="count">{{ count($posts) }}</span>            </li>
            @endforeach
        </ul>
                            </div>
