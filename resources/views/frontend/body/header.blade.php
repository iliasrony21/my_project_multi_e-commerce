        ...
        <div class="header-middle header-middle-ptb-1 d-none d-lg-block">
            <div class="container">
                <div class="header-wrap">
                    ...
                    <a href="index.html"><img src="{{ asset($setting->logo)   }}" alt="logo" /></a>                    </div>
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        ...
                                        <div class="shopping-cart-footer">
                                            <div class="shopping-cart-total">
                                                <h4>Total: <span id="cartSubTotal">  </span> <span>$</span></h4>
                                            </div>
...
<!-- search header style and js code here  -->
   <style>
    #searchProducts{
        position: absolute;
        top: 100%;
...
<!--end search header style and js code here  -->
